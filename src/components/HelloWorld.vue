    ...
    <div class="hello">
      ...
      <div class="centerbox">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
          ...
          <span class="flr " style="font-size:14px; color:red;">一个账号同时只能登录一个人</span>
          <div>
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.$router.push('/home/OnAccess');
        } else {
...
h1{
  font-size:26px; font-weight:700;color:blue; margin-bottom:40px;
}
.centertopbox {
  margin-top: 10%;
  width: 33.3%;
